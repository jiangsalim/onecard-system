    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('super_admin', 'Super Admin'), ('admin', 'Admin'), ('bursar', 'Bursar'), ('gate_staff', 'Gate Staff'), ('class_teacher', 'Class Teacher')], default='gate_staff', max_length=20)),
                ('assigned_location', models.CharField(blank=True, max_length=50, null=True)),
                ('assigned_class', models.CharField(blank=True, max_length=20, null=True)),
                ('assigned_stream', models.CharField(blank=True, max_length=20, null=True)),
